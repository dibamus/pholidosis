...
#'
#' This dataset contains simple networks for use in testing the "pholidosis" package
#' @name simpleGs
#' @docType data
#'
#' @usage data(simpleGs)
...
#
# sg5 <- graph_from_edgelist(matrix(c("A","B","B","C","C","D","D","E","E","A","A","C","A","D"), ncol = 2, byrow = TRUE))
# E(sg5)$weight <- c(1,1,1,1,1,1,1)
#
# sg6 <- graph_from_edgelist(matrix(c("A","B","B","C","C","D","D","E","E","A","E","C","E","B"), ncol = 2, byrow = TRUE))
# E(sg6)$weight <- c(1,1,1,1,1,1,1)
#
# simpleGs <- list("g1"=sg1,"g2"=sg2,"g3"=sg3,"g4"=sg4,"g5"=sg5,"g6"=sg6)
#
# save(simpleGs, file = "data/simpleGs.rda")
